...
DWORD WINAPI HackThread(HMODULE hModule)
{
	...
	Player* localPlayerPtr = *(Player**)(moduleBase + 0x10F4F4);
	PrintInfo(bHealth, bAmmo, bRecoil);
    while (true)
    {
        ...
        if (localPlayerPtr)
        {
            ...
            if (bAmmo)
            {
				...
				localPlayerPtr->rifleAmmo = 1337;
				localPlayerPtr->pistolAmmo = 1337;
            }
